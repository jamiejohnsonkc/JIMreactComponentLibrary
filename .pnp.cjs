...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "fallbackExclusionList": [
      ["JIMreactComponentLibrary", ["workspace:."]]
    ],
    "fallbackPool": [
    ],
    "packageRegistryData": [
      ...
      ["create-react-app", [
        ["npm:4.0.3", {
          "packageLocation": "./.yarn/cache/create-react-app-npm-4.0.3-d2ac11fe65-b5c37d2bc0.zip/node_modules/create-react-app/",
          "packageDependencies": [
            ["create-react-app", "npm:4.0.3"],
            ["chalk", "npm:4.1.0"],
            ["commander", "npm:4.1.1"],
